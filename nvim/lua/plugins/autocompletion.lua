	...
	config = function()
		...
		require("blink-cmp").setup({
			...
			completion = {
				...
				list = {
					selection = {
						-- when there is autocompletion, it will automatically select the first item.
						preselect = true,
						-- when there is an item selected, it will automatically inserts the text this is annoying so im turning it off.
						auto_insert = false,
					},
				},
			},
